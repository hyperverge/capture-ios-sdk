...
public class Global: NSObject {
    ...
    var appID : String? = "demoHV" //Add your AppID here
    var appKey : String? = "demoHV" //Add your AppKey here
    var region : HyperSnapParams.Region? = .AsiaPacific //Set this to .India or .AsiaPacific or .UnitedStates
