...
#ifndef HYPERSNAPSDK_SWIFT_H
#define HYPERSNAPSDK_SWIFT_H
...
@property (nonatomic, readonly, strong) HVRequestData * _Nullable requestData;
...
- (void)setDocReviewSubtitle:(NSString * _Nonnull)text SWIFT_DEPRECATED_MSG("Won't be available after UI/UX revamp");
...
@interface HVDocsViewController : UIViewController <UIViewControllerTransitioningDelegate>
...
- (void)setEncryptPayload:(BOOL)encryptPayload;
- (BOOL)shouldStoreAdditionalModuleData SWIFT_WARN_UNUSED_RESULT;
- (void)setStoreAdditionalModuleData:(BOOL)storeAdditionalModuleData;
- (void)setCPRCheckSessionHeaders:(NSDictionary<NSString *, NSString *> * _Nullable)checkSessionHeaders;
...
@interface HVRequestData : NSObject
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull headers;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, NSString *> * _Nonnull bodyParams;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
